...
You can specify which metrics you want to retrieve from AppDynamics among all available metrics. Since NeoLoad GUI 6.8 version, these metrics are sent to NeoLoad Web.
